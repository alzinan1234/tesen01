...
// Assuming you have politicsData in your data folder
...
const Politics = () => {
  ...
  const [articles, setArticles] = useState(politicsArticles.map(a => ({
    ...a,
    isLiked: false,
  ...
  return (
    <main className="bg-white min-h-screen pt-28 md:pt-64 pb-10">
      <div className="max-w-4xl mx-auto text-center mb-16 px-4">
        <h1 className="text-6xl font-sans text-gray-900 mb-4 font-extrabold tracking-wide">Politics</h1>
        <p className="text-black font-serif text-lg tracking-wide">In-depth reporting on policy and power.</p>
          ...
          <div key={article.id} className="flex flex-col border-b border-gray-50 pb-12 group">
            <div className="flex flex-col md:flex-row gap-10 items-start">
              <div className="flex-1 order-2 md:order-1">
                ...
                <Link href={`/reader/politics/${article.id}`}>
              ...
              <Link href={`/reader/politics/${article.id}`} className="w-full md:w-[320px] h-[200px] rounded-2xl overflow-hidden order-1 md:order-2 shadow-sm relative">
