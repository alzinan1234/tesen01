...
const Travel = () => {
  ...
  const [articles, setArticles] = useState(travelArticles.map(a => ({
    ...a,
    isLiked: false,
  ...
  return (
    <main className="bg-white min-h-screen pt-28 md:pt-64 pb-10">
      <div className="max-w-4xl mx-auto text-center mb-16 px-4">
        <h1 className="text-6xl font-sans text-gray-900 mb-4 font-extrabold tracking-wide">Travel</h1>
        <p className="text-black font-serif text-lg italic tracking-wide">Journeys that transform the soul and expand the horizon.</p>
          ...
          <div key={article.id} className="flex flex-col border-b border-gray-50 pb-12 group">
            <div className="flex flex-col md:flex-row gap-10 items-start">
              <div className="flex-1 order-2 md:order-1">
                ...
                <Link href={`/reader/travel/${article.id}`}>
              ...
              <Link href={`/reader/travel/${article.id}`} className="w-full md:w-[320px] h-[200px] rounded-2xl overflow-hidden order-1 md:order-2 shadow-sm relative">
            ...
            {article.showCommentBox && (
              <div className="mt-6 bg-[#F2F2F2] rounded-2xl p-6 transition-all">
                ...
                <textarea 
                  ...
                  placeholder="Where does this story take you? Write a comment..." rows={2} autoFocus
                />
