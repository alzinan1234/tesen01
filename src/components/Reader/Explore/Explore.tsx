...
// Dhore nicchi apnar data folder e exploreData file ti ache
...
const Explore = () => {
  ...
  const [articles, setArticles] = useState(exploreArticles.map(a => ({
    ...a,
    isLiked: false,
        ...
        {currentArticles.map((article) => (
          <div key={article.id} className="flex flex-col border-b border-gray-50 pb-12 group">
            <div className="flex flex-col md:flex-row gap-10 items-start">
              ...
              <Link href={`/reader/explore/${article.id}`} className="w-full md:w-[320px] h-[200px] rounded-2xl overflow-hidden order-1 md:order-2 shadow-sm">
            ...
            {/* Comment Box matching image_070f7a.png */}
