  ...
  return (
    <main className="bg-white min-h-screen pt-28 md:pt-64 pb-10">
      <div className="max-w-4xl mx-auto text-center mb-16 px-4">
        <h1 className="text-6xl font-sans text-gray-900 mb-4 font-extrabold tracking-wide">Gastronomy</h1>
        <p className="text-black font-serif text-lg tracking-wide">Exploring the intersection of food, culture, and history.</p>
