...
const OtpInput: React.FC<OtpInputProps> = ({ value, onChange, error }) => {
  // Use a single ref array — avoids any hook ordering issues
  const inputRefs = useRef<(HTMLInputElement | null)[]>([null, null, null, null]);

  const digits: string[] = Array.from({ length: 4 }, (_, i) =>
    value[i] ?? ""
  );

  const updateValue = (newDigits: string[]): void => {
...
const useResendTimer = (initial: number = 60): ResendTimerHook => {
      ...
      if (res.success) {
        ...
        setTimeout(() => {
          window.location.href =
            activeRole === "writer" ? "/writer/dashboard" : "/dashboard";
        }, 1500);
      }
    } catch (err: unknown) {
      const msg =
            ...
            {step === "otp" ? (
              <div className="anim-fadeup">
                <div className="text-center mb-8">
                  <h2 className="font-serif text-[35px] text-gray-800 mb-4">
                    Choose Your Role
                  </h2>
                ...
                <div className="mb-8">
                  <h1 className="text-[20px] font-serif font-bold text-gray-900 mb-1">
                    Verify your email
                  </h1>
                ...
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    disabled={
                      otpLoading || otpValue.replace(/\s/g, "").length < 4
                    }
                    className="w-full py-3 bg-gradient-to-r from-[#343E87] via-[#3448D6] to-[#343E87] font-serif text-white rounded-full font-bold shadow-lg hover:opacity-95 transition-all active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                  ...
                  <div className="text-center">
                    {canResend ? (
                      <button
                        ...
                        className="flex items-center gap-1.5 mx-auto text-sm font-serif text-[#3448D6] font-bold hover:underline"
                      >
                  ...
                  <p className="text-center font-serif text-sm text-gray-600">
                    ...
                    <button
                      ...
                      className="text-[#3448D6] font-serif font-bold ml-1 hover:underline"
                    >
                      Go back
                    </button>
                  </p>
              ...
              <div className="anim-fadeup">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  <div className="space-y-1.5">
                    <label className="block text-sm font-bold font-sans text-black">
                      Name
                    </label>
                    <input
                      {...register("name")}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <label
                      htmlFor="remember"
                      className="text-xs font-serif text-gray-500 cursor-pointer"
                    >
                      Remember Me
                    </label>
                  </div>
                ...
                <p className="text-center font-serif text-black text-sm text-gray-600 mb-12">
                  ...
                  <Link
                    href="/"
                    className="text-[#3448D6] font-serif font-bold ml-1"
                  >
                    Login
                  </Link>
                </p>
