    ...
    return (
      <div className="max-w-7xl mx-auto px-6 py-20 font-sans text-black pt-28 md:pt-40">
        ...
        <div className="space-y-16 animate-pulse">
          {[1, 2].map(i => (
            <div key={i} className="flex flex-col md:flex-row gap-10 items-start pb-16">
  ...
  if (error) {
    return (
      <div className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <button onClick={fetchPodcasts} className="mt-4 px-4 py-2 bg-black text-white rounded-lg">Retry</button>
      </div>
    );
  }
